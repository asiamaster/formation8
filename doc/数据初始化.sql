...
##调度器
INSERT INTO `schedule_job` (`id`, `created`, `modified`, `job_name`, `job_group`, `job_status`, `job_data`, `cron_expression`, `repeat_interval`, `start_delay`, `description`, `bean_class`, `spring_id`, `url`, `is_concurrent`, `method_name`) VALUES (1, '2017-05-12 15:08:17', '2017-05-15 14:03:11', 'order_scan_job', 'formation8', 0, NULL, '0 0/1 14 * * ?', NULL, NULL, '订单后台扫描', NULL, 'orderScanComponent', NULL, 0, 'scan');
INSERT INTO `schedule_job` (`id`, `created`, `modified`, `job_name`, `job_group`, `job_status`, `job_data`, `cron_expression`, `repeat_interval`, `start_delay`, `description`, `bean_class`, `spring_id`, `url`, `is_concurrent`, `method_name`) VALUES (2, '2017-05-15 14:52:33', '2017-05-15 15:00:45', 'platform_transfer_job', 'formation8', 0, NULL, NULL, 60, NULL, '平台打款', NULL, 'platformTransferComponent', NULL, 0, 'scan');
