/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     2017/4/28 星期五 10:22:52                       */
/*==============================================================*/
...
alter table biz_number comment '记录所有业务的编号
如：
充值订单:DO20170427000000
产品订单:PO';
...
(
   ...
   status               int comment '1:众筹中;2:众筹成功;3众筹失败,4:待付款,5:付款成功;6:付款失败',
   price                bigint comment '投资金额',
   transaction_type     int comment '1:钱;2:产品;  众筹成功后可以选产品',
   type                 int not null comment '1:产品, 2:充值',
   primary key (id)
);

alter table `order` comment '充值必须要记录订单，用于支付宝回调验证订单号';
