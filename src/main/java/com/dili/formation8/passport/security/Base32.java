                ...
                if (digit != 255) {
                    if (index <= 3) {
                        ...
                        if (index == 0) {
                            int tmp90_88 = offset;
                            byte[] tmp90_86 = bytes;
                            tmp90_86[tmp90_88] = ((byte) (tmp90_86[tmp90_88] | digit));
                            offset++;
                            if (offset >= bytes.length)
                                break;
                        } else {
                            int tmp115_113 = offset;
                            byte[] tmp115_111 = bytes;
                            tmp115_111[tmp115_113] = ((byte) (tmp115_111[tmp115_113] | digit << 8 - index));
                        }
                    } else {
                        index = (index + 5) % 8;
                        int tmp141_139 = offset;
                        byte[] tmp141_137 = bytes;
                        tmp141_137[tmp141_139] = ((byte) (tmp141_137[tmp141_139] | digit >>> index));
                        offset++;

                        if (offset >= bytes.length)
                            break;
                        int tmp168_166 = offset;
                        byte[] tmp168_164 = bytes;
                        tmp168_164[tmp168_166] = ((byte) (tmp168_164[tmp168_166] | digit << 8 - index));
                    }
                }
            }
        }
